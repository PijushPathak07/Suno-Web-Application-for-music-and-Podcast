  ...
  return (
      ...
      <nav className="px-2">
        ...
        <ul className="flex flex-col">
            ...
            <li>
                <NavLink activeClassName="!text-white" to={"/podcast"} className="h-10 flex items-center text-sm font-bold text-link hover:text-white px-4 gap-4 transition-colors">
                {window.location.href === 'http://localhost:3000/podcasts' ? <Icon name="actpodcasts"/> : <Icon name="lib"/>}

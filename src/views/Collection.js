...
export default function Collection() {
  const items =[
    {
      id: 1,
      title: 'Blend Mix',
      artist: 'A glorious blend of all my favourite genres and artists',
...

    {
      id: 2,
      title: 'Collaboration',
      artist: 'Collaboration music picked just for you.',
...

    {
      id: 3,
      title: 'Deep House',
      artist: 'Deep House in all its shapes and colours.ites üçten beşe',
  ...
  return (
    <div>
            <h3 className='text-2xl text-white font-bold tracking-tight mb-4'>Playlists</h3>
